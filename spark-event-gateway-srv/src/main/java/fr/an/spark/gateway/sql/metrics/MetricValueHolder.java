...
public class MetricValueHolder {
    ...
    public MetricValueHolder(SparkPlanNode attachedNode, Metrics metric, SparkPlanTree previousTree) {
    ...
    public boolean equalsSameTypeAndId(MetricValueHolder right) {
        return this.metric.accumulatorId == right.metric.accumulatorId
                && Objects.equals(this.metric.name, right.metric.name)
                && Objects.equals(this.metric.metricType, right.metric.metricType);
    }
