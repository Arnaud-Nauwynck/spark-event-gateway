...
export class MetricValueHolder {
  ...
  get name(): string { return this.metricDescription.name; }
  get metricType(): string { return this.metricDescription.type; }
  // get accumulatorId(): number { return this.accumulatorId; }
  ...
  constructor(attachedNode: SparkPlanNode,
    ...
    this.metricDescription = metricDescription; // MetricDescriptionRegistry.INSTANCE.resolve(metricName, metricType);
