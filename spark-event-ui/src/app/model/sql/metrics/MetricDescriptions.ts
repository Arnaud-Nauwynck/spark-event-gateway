...
export class RemoteMergedReqsDurationMetricDescription extends MetricDescription {
  constructor() {
    super('remote merged reqs duration', 'timing', 'millis');
  }
}

export class RemoteMergedBlocksFetchedMetricDescription extends MetricDescription {
  constructor() {
    super('remote merged blocks fetched', 'sum', 'blocks');
  }
}

export class MergedFetchFallbackCountMetricDescription extends MetricDescription {
  constructor() {
    super('merged fetch fallback count', 'sum', 'blocks');
  }
}

export class RemoteMergedChunksFetchedMetricDescription extends MetricDescription {
  constructor() {
    super('remote merged chunks fetched', 'sum', 'chunks');
  }
}

export class LocalMergedBytesReadMetricDescription extends MetricDescription {
  constructor() {
    super('local merged bytes read', 'size', 'bytes');
  }
}

export class LocalMergedChunksFetchedMetricDescription extends MetricDescription {
  constructor() {
    super('local merged chunks fetched', 'sum', 'chunks');
  }
}

export class RemoteMergedBytesReadMetricDescription extends MetricDescription {
  constructor() {
    super('remote merged bytes read', 'size', 'bytes');
  }
}

export class LocalMergedBlocksFetchedMetricDescription extends MetricDescription {
  constructor() {
    super('local merged blocks fetched', 'sum', 'blocks');
  }
}

export class CorruptMergedBlockChunksMetricDescription extends MetricDescription {
  constructor() {
    super('corrupt merged block chunks', 'sum', 'chunks');
  }
}

export class RemoteReqsDurationMetricDescription extends MetricDescription {
  constructor() {
    super('remote reqs duration', 'timing', 'millis');
  }
}

export class TimeInAggregationBuildMetricDescription extends MetricDescription {
  constructor() {
    super('time in aggregation build', 'timing', 'millis');
  }
}

export class NumberOfSortFallbackTasksMetricDescription extends MetricDescription {
  constructor() {
    super('number of sort fallback tasks', 'sum', 'count');
  }
}

export class AvgHashProbesPerKeyMetricDescription extends MetricDescription {
  constructor() {
    super('avg hash probes per key', 'average', 'count');
  }
}

export class AvgHashProbeBucketListItersMetricDescription extends MetricDescription {
  constructor() {
    super('avg hash probe bucket list iters', 'average', 'unit?');
  }
}
...
export function registerStdMetricDescriptions(registry: MetricDescriptionRegistry) {
  registry.registers([
    ...
    new AvgHashProbesPerKeyMetricDescription(),
